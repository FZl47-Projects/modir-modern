    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('MOBILE_VERIFICATION_CODE', 'کد تاییدیه موبایل'), ('SUBSCRIPTION_END_WARNING', 'Subscription end warning')], max_length=128, verbose_name='نوع اعلان')),
